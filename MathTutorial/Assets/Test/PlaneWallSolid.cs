...
public class PlaneWallSolid : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var planeNormal = MyMath.Cross(plane.v, plane.u);
        var reflectVect = L1.Reflect(planeNormal);
        var reflectLine = new Line(L1.Lerp(intersectT), L1.Lerp(intersectT) + reflectVect*5);
        reflectLine.Draw(1,Color.red);
    }
